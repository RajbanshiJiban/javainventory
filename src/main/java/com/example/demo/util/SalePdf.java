...
public class SalePdf extends AbstractPdfView{
	...
	@Override
	 ...
	 protected void buildPdfDocument(
	  ...
	  Paragraph title = new Paragraph("Sell DATA",titleFont);
	  ...
	  table.addCell(new Phrase("Inventory Name",tableHead));
	  ...
	  for(Sell sell : list ) {
	   ...
	   table.addCell(String.valueOf(sell.getSelquantity()));
	   table.addCell(String.valueOf(sell.getInventory().getInvname()));
